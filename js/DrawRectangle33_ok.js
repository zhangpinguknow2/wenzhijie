export default function DrawRectangle (id, onMouseUp, params, className){
  ...
  this.isDraw = false;
  this.isMouseUp = true;
  this.index = (params && params.index) || ((params && params.index === 0) ? 0 : 20);
  this.currentDrawRectangle = null;
  this.className = className;
  this.count = (params && params.count) || 21
  console.log(7777722, this.index, this.count)
  this.cross = false
  this.RectangleDivs = (params && params.RectangleDivs) || [];
  this.rectangleList = (params && params.rectangleList) || [];
  this.temprectangle = {}
...
DrawRectangle.prototype = {
  ...
  onMouseUp: function(){
      ...
      console.log(66,this.RectangleDivs,this.rectangleList)
