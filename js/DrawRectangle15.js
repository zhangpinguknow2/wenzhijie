...
//  		console.log(3333333, rect1, rect2)
    		...
    		var r1 = {x: rect1.x + rect1.drawW, y: rect1.y + rect1.drawH}
    		var l2 = { x: rect2.x, y: rect2.y }
    		var r2 = { x: rect2.x + rect2.drawW, y: rect2.y + rect2.drawH }
    		if (rect2.drawW < 0) {
    			if (l1.x < r2.x || l2.x > r1.x || l1.y > r2.y || l2.y > r1.y) {
    				console.log(44444444, l1.x < r2.x,l2.x > r1.x,  l1.y > r2.y, l2.y > r1.y)
    				return true
    			} else {
    				console.log(55555555555, l1.x < r2.x,l2.x > r1.x,  l1.y > r2.y, l2.y > r1.y)
    				return false
    			}
    		} else if (rect2.drawW > 0) {
    			if (l1.x > r2.x || l2.x > r1.x || l1.y > r2.y || l2.y > r1.y) {
