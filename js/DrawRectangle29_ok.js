...
//  		console.log(7788, currentid)
  ...
  drawLayer: function(){
     ...
     // document.body.appendChild(d);
      ...
      console.log(444, this.RectangleDivs)
  },
...
//          		console.log(this.temprectangle)
  ...
  onMouseUp: function(){
      ...
      //this.IMG.releaseCapture();
       ...
       if (offsetw < 5) {
         deleteid = parseInt(this.currentDrawRectangle.id.substr(4,1))
         console.log(8842, deleteid)
      ...
      this.rectangleList.forEach(function(item, index){
        console.log(9911, this.temprectangle, item)
      ...
      if (deleteid) {
        // this.currentDrawRectangle.remove()
        deleteid = parseInt(deleteid.substr(4,1))
