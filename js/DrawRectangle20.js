      ...
      if (this.isDraw && !this.cross) {
          ...
          if (this.debug) {
              this.temprectangle = {
                ...
                rectW: this.currentDrawRectangle.style.width,
                rectH: this.currentDrawRectangle.style.height,
                startx: this.currentDrawRectangle.style.left,
                starty: this.currentDrawRectangle.style.top,
                endx: endx,
                endy: endy
              }
