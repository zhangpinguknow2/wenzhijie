...
//  			console.log(331,item)
			let isCrossx = item.left < event.offsetX && item.right > event.offsetX
			let isCrossy = item.top < event.offsetY && item.bottom > event.offsetY
    			if (isCrossx && this.isDraw) {
    				console.log(44, this.isDraw)
    				this.tempCrossx = true
    			} else if (isCrossy && this.isDraw) {
    				this.tempCrossy = true
    				console.log(66, this.isDraw)
    			}
    			console.log(5555555, this.tempCrossx, this.tempCrossy, this.isDraw)
    			if (this.tempCrossx && this.tempCrossy && this.isDraw) {
    				this.cross = true
    			}
    		}.bind(this))
